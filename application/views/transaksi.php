	...
	<div class="box">            
        <div class="box-header">
            <a href="<?php echo base_url()?>transaksi/tambah" class="btn btn-info"><i class="fa fa-fw fa-plus"></i>Tambah Pembayaran</a>			
        </div><!-- /.box-header -->
        <div class="box-body">
        <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                            <tr>
								...
								<td style="text-align: center"><?php echo $query->tgl_bayar; ?></td>								
								<td style="text-align: center"><?php echo $query->jenis; ?></td>
								<td style="text-align: center">Rp.<?php echo number_format($query->jml_bayar); ?></td>
                            </tr>
                      <?php   }  ?>
                    </tbody>
        </table>

        ...
        <table id="example2" class="table table-bordered table-striped">
                    ...
                    ?>
                            <tr>
								...
								<td style="text-align: center"><?php echo $query->SendingDateTime; ?></td>
								<td style="text-align: center"><?php echo $query->DestinationNumber; ?></td>
								<td><?php echo $query->TextDecoded; ?></td>														
                                <td style="text-align: center">
								<div class="btn-group">                                                                   
								  <a href="<?php echo base_url()?>pesan/sentboxhapus/<?php echo $query->ID;?>" data-toggle="tooltip" title="Hapus Pesan" onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini');"><button type="button" class="btn btn-danger" ><i class="fa fa-fw fa-trash"></i></button></a>
                                </div>								
                               </td>
                            </tr>
                      <?php   }  ?>

    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
		  ...
		  ?>
            Laporan Pemasukan Bulan <?php echo $bulan; ?> Periode <?php echo $periode; ?>
        ...
        <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                            <tr>
								...
								<td><?php echo 'Rp.'.number_format($query->nominal_spp).''; ?></td>
								<td><?php echo 'Rp.'.number_format($query->telah_bayar).''; ?></td>

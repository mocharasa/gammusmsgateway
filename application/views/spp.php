        ...
        <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                            <tr>
								...
								<div class="btn-group">
                                  <a href="<?php echo base_url()?>spp/view/<?php echo $query->nis;?>" data-toggle="tooltip" title="Lihat Detail"><button type="button" class="btn btn-info"><i class="fa fa-fw fa-external-link"></i></button></a>                                  
                                </div>								
                               </td>
                            </tr>
                      <?php   }  ?>

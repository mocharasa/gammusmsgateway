...
<body>
  ...
  <form method="post" action="<?php echo base_url("index.php/Upload/form"); ?>" enctype="multipart/form-data">
    <!-- 
  ...
  if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
    ...
    echo "<form method='post' action='".base_url("index.php/Upload/import")."'>";
    ...
    foreach($sheet as $row){ 
      ...
      $kelas = $row['C']; // Ambil data jenis kelas
      $tempat_lahir = $row['D']; // Ambil data tempat lahir
	  $tgl_lahir = $row['E'];
	  $jk = $row['F'];
      $alamat = $row['G'];
      ...
      if($numrow > 1){
		...
		echo "<td".$tanggal_td.">".$tgl_lahir."</td>";
		echo "<td".$jk_td.">".$jk."</td>";
    ...
    <?php
      ...
      echo "<a href='".base_url("index.php/upload")."'>Cancel</a>";
    }

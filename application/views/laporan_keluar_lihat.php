    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
		  ...
		  ?>
            Laporan Pengeluaran Bulan <?php echo $bulan; ?> Periode <?php echo $periode; ?>
        ...
        <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                            <tr>
								...
								<td><?php echo 'Rp.'.number_format($query->anggaran_keluar).''; ?></td>
								<td><?php echo $query->keperluan; ?></td>
								<td><?php echo 'Rp.'.number_format($query->total_kas).''; ?></td>																						                                							
                               </td>
                            </tr>
                      <?php   }  ?>
                    </tbody>
